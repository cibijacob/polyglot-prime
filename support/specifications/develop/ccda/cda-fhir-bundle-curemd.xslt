...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
  ...
  <xsl:variable name="patientRoleId" select="//ccda:patientRole/ccda:id[@root = '2.16.840.1.113883.3.669.767703'][1]/@extension"/>
  ...
  <xsl:template match="/">
  {
    ...
    , "entry": [
      <xsl:apply-templates select="/ccda:ClinicalDocument/ccda:recordTarget/ccda:patientRole
                                ...
                                | /ccda:ClinicalDocument/ccda:componentOf/ccda:encompassingEncounter/ccda:location[position()=1]/ccda:healthCareFacility/ccda:serviceProviderOrganization
                                "/>
  ...
  <xsl:template name="ComponentEncounter" match="/ccda:ClinicalDocument/ccda:component/ccda:structuredBody/ccda:component/ccda:section[@ID='encounters']/ccda:entry[position()=1]/ccda:encounter">
    ,{
      ...
      "resource": {
        ...
        <xsl:if test="string($locationResourceId) or normalize-space(ccda:participant[position()=1]/ccda:participantRole/ccda:playingEntity/ccda:name)">
        , "location": [
            {
                "location": {
                    ...
                    <xsl:if test="normalize-space(ccda:participant[position()=1]/ccda:participantRole/ccda:playingEntity/ccda:name)">
                      "display": "<xsl:call-template name="string-trim">
                                    <xsl:with-param name="text" select="ccda:participant[position()=1]/ccda:participantRole/ccda:playingEntity/ccda:name"/>
                                  </xsl:call-template>"
                    </xsl:if>
                }
            }
  ...
  <xsl:template name="LocationResource" match="/ccda:ClinicalDocument/ccda:componentOf/ccda:encompassingEncounter/ccda:location[position()=1]/ccda:healthCareFacility/ccda:serviceProviderOrganization">
